...
- Vite: nopea kehitysympäristö Reactille
...
- Backend toteutettiin Expressillä ja yhdistettiin PostgreSQL-tietokantaan.
- Luotiin ajat-taulu ja toteutettiin ensimmäiset toiminnallisuudet ajanvaraukselle.
- Reaaliaikaiset tilapäivitykset ja käyttöliittymän kalenterinäkymät saatiin toimimaan.
...
- Backend ja tietokanta yritettiin siirtää Azureen, mutta teknisiä haasteita ei saatu ratkottua aikarajoissa – päätettiin pitää paikallisena. Tietokanta toteutettiin pgAdmin 4 -sovelluksen avulla.
...
- Varausilmoitukset (esim. sähköposti) ja asiakkaan puolesta tehtävät varaukset jätettiin tulevaisuuden kehityskohteiksi.
...
- Reaaliaikainen päivitys ilman sivun latausta:
    Varausnäkymä päivittyy automaattisesti onnistuneen varauksen jälkeen – tämä paransi käytettävyyttä merkittävästi.
- Testaus: 
...
- Aikatauluhaasteet:
    JWT-autentikointi jäi pois.
- Ilmoitustoiminnot (esim. sähköposti) jäivät pois käytännön rajoitteiden vuoksi.

**Jatkokehitysideoita:**
- JWT- ja OAuth-autentikointi.
- Varausilmoitukset (esim. sähköposti, tekstiviesti).
